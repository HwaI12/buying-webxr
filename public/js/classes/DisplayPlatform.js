 ...
 * 白い四角柱を管理
 */
export class DisplayPlatform {
  /**
   * @param {Object} config - 四角柱の設定オブジェクト
   * @param {string} config.id - 四角柱のID
  ...
  create(scene) {
    ...
    // マテリアル設定
    this.entity.setAttribute('material', 'roughness: 0.3; metalness: 0.1');
